...
class BaseOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--data_path', type=str, default='/home/leiguojun/data/')
        ...
        parser.add_argument('--num_filters', default=[32, 32, 32])
        parser.add_argument('--deconv_kernels', default=[2, 2, 2])
